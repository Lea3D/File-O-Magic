...
$dropdownPreset = New-Object System.Windows.Forms.ComboBox
$dropdownPreset.Items.AddRange(@("color_preset_1.cfg", "color_preset_2.cfg", "color_preset_3.cfg", "color_preset_4.cfg"))
$dropdownPreset.SelectedIndex = 0
$dropdownPreset.Location = New-Object System.Drawing.Point(10, 300)
$dropdownPreset.Width = 200
$form.Controls.Add($dropdownPreset)
...
# Event-Handler für Preset-Auswahl -> Wird sofort angewendet
$dropdownPreset.Add_SelectedIndexChanged({
    $presetFile = ".\$($dropdownPreset.SelectedItem)"
